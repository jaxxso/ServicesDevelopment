...
namespace NetBank.Api2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s => s.SwaggerDoc("v1", new OpenApiInfo { Title = "ReportedCard API", Version = "v1" }));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(s => s.SwaggerEndpoint("/swagger/v1/swagger.json", "ReportedCard API"));
        }
    }
}
